...
const TEMPLATES = [
  ...
  },
  {
    ...
    category: "E-commerce",
    tag: "Disponible",
    desc: "Boutique en ligne de vente alimentaire avec catalogue produits, panier et commande en ligne.",
    tech: ["E-commerce", "Vente Alimentaire", "Responsive"],
    color: "#f0fdf4",
    accent: "#16a34a",
    siteUrl: "https://www.aboufamily.com/",
    previewImage: "https://api.microlink.io/?url=https://www.aboufamily.com/&screenshot=true&meta=false&embed=screenshot.url",
    isLive: true,
  },
  {
    id: 3,
