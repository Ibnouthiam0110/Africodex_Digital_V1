...
const TEMPLATES = [
  { id: 1, title: "Site Vitrine Restaurant", category: "Site Vitrine", tag: "Bientot disponible", desc: "Site elegant pour restaurant avec menu, reservations en ligne et galerie photos.", tech: ["React", "Node.js", "Figma"], color: "#fdf6e3", accent: "#b8860b", icon: "🍽️" },
  { id: 2, title: "Boutique Mode Africaine", category: "E-commerce", tag: "Bientot disponible", desc: "Boutique en ligne complete avec catalogue, panier et paiement Wave et Orange Money.", tech: ["React", "Stripe", "MongoDB"], color: "#f0f7ff", accent: "#2563eb", icon: "👗" },
  { id: 3, title: "App Livraison Locale", category: "Application Mobile", tag: "Bientot disponible", desc: "Application mobile de livraison avec geolocalisation, tracking et paiement mobile.", tech: ["React Native", "Firebase", "Maps"], color: "#f0fdf4", accent: "#16a34a", icon: "🛵" },
  { id: 4, title: "Cabinet Medical", category: "Site Vitrine", tag: "Bientot disponible", desc: "Site professionnel pour cabinet medical avec prise de rendez-vous en ligne.", tech: ["Next.js", "Tailwind", "Cal.com"], color: "#fdf6e3", accent: "#b8860b", icon: "🏥" },
  { id: 5, title: "Marketplace Artisanat", category: "E-commerce", tag: "Bientot disponible", desc: "Marketplace multi-vendeurs dediee a l'artisanat africain avec gestion des commissions.", tech: ["Next.js", "Prisma", "Wave API"], color: "#fdf4ff", accent: "#9333ea", icon: "🎨" },
  { id: 6, title: "Dashboard Analytics", category: "Dashboard", tag: "Bientot disponible", desc: "Tableau de bord avec statistiques en temps reel et rapports personnalises.", tech: ["React", "Chart.js", "REST API"], color: "#f0f7ff", accent: "#2563eb", icon: "📊" },
];
  ...
  return (
    <section id="realisations" style={{ padding: isMobile ? "4rem 1.2rem" : "7rem 5rem", background: "#fff" }}>
      <div style={{ marginBottom: "2.5rem" }}>
        <SectionHeader label="Nos Realisations" title="Templates & <em style='font-family:Fraunces,serif;font-style:italic;color:#b8860b'>Projets</em>" subtitle="Decouvrez nos modeles et realisations. Des templates prets a personnaliser pour lancer votre projet rapidement." />
      </div>
      ...
      <div style={{ textAlign: "center", marginTop: "3rem", padding: isMobile ? "2rem 1.2rem" : "3rem", background: "#faf8f4", borderRadius: "20px", border: "1px solid #e5dfd3" }}>
        <h3 style={{ fontSize: "1.4rem", fontWeight: 800, color: "#111110", marginBottom: "0.8rem" }}>Vous avez un projet en tete ?</h3>
